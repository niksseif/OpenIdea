  ...
  return knex('ideas').del()
    .then(function () {
      ...
      return knex('ideas').insert([
        ...
        {id: 3, users_id: 3,title:'My new project', description:'I want to write a book',image_url:'https://i.pinimg.com/564x/c9/99/3c/c9993c6c4093d50745f8cbc5335196ac.jpg'},
        {id: 4, users_id: 1,title:'My new project', description:'Oxygen',image_url:'https://i.pinimg.com/564x/41/c8/d7/41c8d7be885cd2821a0c43a2dfe07fa4.jpg'}
      ]);
    });
};
